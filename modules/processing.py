...
class StableDiffusionProcessingTxt2Img(StableDiffusionProcessing):
    ...
    def __init__(self, enable_hr: bool=False, denoising_strength: float=0.75, firstphase_width: int=0, sampler_name_hr: str=None, steps_hr: int=None, cfg_scale_hr: float=None, latent_upscale_hr: str=None,firstphase_height: int=0, **kwargs):
